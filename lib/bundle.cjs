...
var DataGridDefaultRenderersContext = /*#__PURE__*/react.createContext(undefined);
...
var RowSelectionContext = /*#__PURE__*/react.createContext(undefined);
var RowSelectionProvider = RowSelectionContext.Provider;
var RowSelectionChangeContext = /*#__PURE__*/react.createContext(undefined);
var RowSelectionChangeProvider = RowSelectionChangeContext.Provider;
function useRowSelection() {
  var rowSelectionContext = react.useContext(RowSelectionContext);
  var rowSelectionChangeContext = react.useContext(RowSelectionChangeContext);
...
var useLayoutEffect = typeof window === 'undefined' ? react.useEffect : react.useLayoutEffect;
...
function useColumnWidths(columns, viewportColumns, templateColumns, gridRef, gridWidth, resizedColumnWidths, measuredColumnWidths, setResizedColumnWidths, setMeasuredColumnWidths, onColumnResize) {
  var prevGridWidthRef = react.useRef(gridWidth);
...
function useLatestFunc(fn) {
  ...
  var callbackFn = react.useCallback(function () {
...
function useViewportColumns(_ref) {
  ...
  var startIdx = react.useMemo(function () {
...
function EditCell(_ref) {
  ...
  var frameRequestRef = react.useRef();
...
var RowComponent = /*#__PURE__*/react.memo( /*#__PURE__*/react.forwardRef(Row));
...
function DataGrid(props, ref) {
  ...
  var getColumnWidth = react.useCallback(function (column) {
  ...
  var prevSelectedPosition = react.useRef(selectedPosition);
  var latestDraggedOverRowIdx = react.useRef(draggedOverRowIdx);
  var lastSelectedRowIdx = react.useRef(-1);
  var focusSinkRef = react.useRef(null);
  var shouldFocusCellRef = react.useRef(false);
  ...
  var setDraggedOverRowIdx = react.useCallback(function (rowIdx) {
...
function TreeDataGrid(_ref, ref) {
  ...
  var getParentRowAndIndex = react.useCallback(function (row) {
  ...
  var rowKeyGetter = react.useCallback(function (row) {
    if (isGroupRow(row)) {
      return row.id;
    }
